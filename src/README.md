...
Note: compared to flosic_os.py@master, flosic_os.py@Development/JaK has fixed a flosic_os/flosic_scf consistency problem in def get_fermi_forces() which caused errors for spin != 0
